      ...
      <div className='flex flex-col items-center justify-center '>
        ...
        <form className='w-full h-full flex justify-center' onSubmit={handleLogin}>
          <div className='bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-16'>
            ...
            <p className='text-sm my-4 font-medium leading-none text-gray-500 flex flex-row'>
              Dont have account?{' '}
              <span className='flex-grow' />
              <Link to='/register' tabIndex={0} aria-label='Sign up here' className='text-sm font-medium leading-none underline text-gray-800 cursor-pointer'>
                {' '}
                Sign up here
              </Link>
            </p>
