...
export const Profile = () => {
  ...
  return (
    isAuthenticated && (
      <div className='w-full h-full flex justify-center capitalize animate__animated animate__fadeInRightBig'>
          ...
          >
            <div className='w-full flex flex-row'>
              ...
              <div className='w-full text-right text-gray-700 font-semibold relative pt-3 md:pt-0'>
                <div className='text-2xl text-white leading-tight inline'>{user.name}</div>
