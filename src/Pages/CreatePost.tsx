...
export const CreatePost = (props) => {
    ...
    <FlashMessage>
      <div className='absolute flex w-full h-full justify-center top-0 z-50 transition-all duration-500' style={{ backgroundColor: 'rgba(0,0,0,0.7)' }}>
        ...
        >
          ...
          <Link to='/dashboard' className='absolute bottom-0 right-0 mb-2 mr-2 focus:ring-2 focus:ring-offset-2 focus:ring-purple-700 text-sm font-semibold leading-none text-white focus:outline-none bg-purple-700 border rounded hover:bg-purple-600 p-4'>
  ...
  function handleOnSubmit (e: any ):any {
    e.preventDefault()
  ...
  return (
    <>
      {(flashMessage)
        ...
        : ''}
      <form
        className='w-full flex justify-center mb-10 px-4'
      ...
      >
        ...
        <div className='bg-white  shadow rounded lg:w-2/3  md:w-1/2 w-full  p-10 mt-16'>
          ...
          <div className='mt-8'>
            <button aria-label='create my account' type='submit' className='focus:ring-2 focus:ring-offset-2 focus:ring-purple-700 text-sm font-semibold leading-none text-white focus:outline-none bg-purple-700 border rounded hover:bg-purple-600 py-4 w-full'>
              {(params.new)
                ? 'Edit my post'
                : 'Create post'}
            </button>
